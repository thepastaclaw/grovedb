...
a dalsi. Ve vychozim nastaveni vyvolava nalezeni nesoucetoveho, nereferencniho elementu chybu.
...
Priznak `hard_limit_reached` ukazuje, zda bylo dosazeno systemoveho pevneho limitu skenovani
...
| `new_with_keys(keys, sum_limit, limit)` | Vice konkretnich klicu |
